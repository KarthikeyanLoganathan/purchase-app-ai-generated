class QuotationItem {
  ...
  static const Map<String, String> _entityToDbFields = {
    ...
    'basketItemUuid': 'basket_item_uuid',
    'vendorPriceListUuid': 'vendor_price_list_uuid',
    'itemAvailableWithVendor': 'item_available_with_vendor',
  ...
  static const Map<String, String> _dbToEntityFields = {
    ...
    'item_available_with_vendor': 'itemAvailableWithVendor',
