...
class DatabaseHelper {
  ...
  Future<int> updateProject(Project project) async {
    ...
    if (result > 0) {
      await logChange('projects', project.uuid, ChangeModes.update);
    }
  ...
  Future<int> deleteProject(String uuid) async {
    ...
    if (result > 0) {
      await logChange('projects', uuid, ChangeModes.delete);
    }
  ...
  Future<void> clearAllData() async {
    ...
    for (String table in DataDefinition.allDataTables) {
  ...
  Future<Map<String, int>> getTableCounts() async {
    ...
    for (var table in DataDefinition.allTables) {
  ...
  Future<void> logChange(
    ...
    final db = await database;
    final tableIndex = DataDefinition.getTableIndex(tableName);
