                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Dismissible(
                              ...
                              child: ListTile(
                                ...
                                subtitle: Text(
                                  'Price: ${vpl.rate.toStringAsFixed(SettingsManager.instance.getCurrencyDecimalPlaces(vpl.currency ?? ''))} ${vpl.currency ?? ''} | Tax: ${vpl.taxPercent.toStringAsFixed(SettingsManager.instance.getPercentDecimalPlaces())}%',
                                  style: TextStyle(
                                    fontSize: 13,
