...
class _QuotationItemDetailScreenState extends State<QuotationItemDetailScreen> {
  ...
  Future<void> _loadData() async {
    ...
    final basket = await _dbHelper.getBasket(widget.quotationItem.basketUuid);
                ...
                if (value == 'copy_key') {
                  ...
                  if (mounted) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                          content:
                              Text('Key copied: ${widget.quotationItem.uuid}')),
                    );
                  }
                }
              },
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildInfoRow(
                          'Quantity:',
                          widget.quotationItem.quantity.toStringAsFixed(
                              SettingsManager.instance
                                  .getUnitOfMeasureDecimalPlaces(
                                      widget.quotationItem.unitOfMeasure ??
                                          '')),
                        ),
                        if (widget.quotationItem.maxRetailPrice != null)
                          _buildInfoRow(
                            'MRP per unit:',
                            '${widget.quotationItem.currency} ${widget.quotationItem.maxRetailPrice!.toStringAsFixed(SettingsManager.instance.getCurrencyDecimalPlaces(widget.quotationItem.currency))}',
                          ),
                      ],
                    ),
                  ),
