          ...
          : Column(
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    '${widget.basket.description ?? 'Basket #${widget.basket.id ?? ''}'} • ${widget.basket.numberOfItems} Items • ${widget.basket.currency} ${widget.basket.totalPrice.toStringAsFixed(SettingsManager.instance.getCurrencyDecimalPlaces(widget.basket.currency))}',
            ...
            subtitle: Column(
              ...
              children: [
                ...
                if (bv.expectedDeliveryDate != null) ...[
                  ...
                  Text(
                      'Expected: ${_formatDate(bv.expectedDeliveryDate!.toIso8601String())}'),
                ],
                const SizedBox(height: 4),
                Row(
                  children: [
                ...
                const SizedBox(height: 4),
                Text(
                  'Base: ${bv.currency} ${bv.basePrice.toStringAsFixed(SettingsManager.instance.getCurrencyDecimalPlaces(bv.currency))} + Tax: ${bv.taxAmount.toStringAsFixed(SettingsManager.instance.getCurrencyDecimalPlaces(bv.currency))}',
                  style: const TextStyle(fontSize: 12),
                ),
                const SizedBox(height: 2),
                Text(
                  'Total: ${bv.currency} ${bv.totalAmount.toStringAsFixed(SettingsManager.instance.getCurrencyDecimalPlaces(bv.currency))}',
                  style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontSize: 16,
                    color: isBestPrice
